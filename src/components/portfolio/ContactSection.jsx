...
const controls = [
  { name: "name", placeholder: "Enter your name", type: "text", lable: "Name" },
  { name: "email", placeholder: "Enter your Email", type: "text", lable: "Email" },
  { name: "message", placeholder: "Enter your message", type: "text", lable: "Message" },
];
                ...
                controlItem.name === "message" ? (
                  <div key={i} className="p-2 w-full">
                    <div className="relative">
                      <label className="text-sm text-[#000]">{controlItem.lable}</label>
                      <textarea
                        id={controlItem.name}
