...
const controls = [
  ...
  { name: 'password', placeholder: 'Enter Password', type: 'text', label: 'Enter Password' },
]

export default function LoginForm({ formData, setFormData, handleLogin }: LoginFormProps) {
  return (
